  ...
  return (
     ...
     <div className='bg-black text-white text-center'>
        ...
        <div>
            ...
            <p className='py-4 text-3xl'>The Defi protocol stystem empowers developers, liquidity providers, and traders to participate
                in a financial marketplace that is open and accessible to all.
            </p>
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>

                <AboutCard icon={<SiHiveBlockchain size={40} /> } heading='Reliable, tamper-proof setwork' 
